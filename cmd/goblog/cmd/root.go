...
var rootCmd = &cobra.Command{
	Use:   "Goblog",
	Short: "This is an opensource blog",
	Long:  `Goblog is an open-source blog`,
	RunE:  run,
}
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName("go-blog-server")
		viper.AddConfigPath(".")
		viper.AddConfigPath("$HOME/.config/go-blog-server")
		viper.AddConfigPath("/etc/go-blog-server")
